...
AGENTS.md for Codex / OpenCode / Cursor / Gemini CLI / Kimi Code,
...
- **From the agent** (no terminal needed): ask "refresh the ai-memory
  ...
  OpenCode / Cursor / Gemini / Kimi Code -> `AGENTS.md`), uses its Write /
  Edit tool to replace or append the returned `markered_block` while preserving
