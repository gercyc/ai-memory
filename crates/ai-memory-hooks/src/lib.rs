...
pub use assistant_capture::{
    ASSISTANT_EXCERPT_MAX_BYTES, ASSISTANT_MESSAGE_MAX_INPUT_BYTES, ASSISTANT_PROTOCOL_VERSION,
    assistant_message_field, strip_assistant_message_raw,
};
